...
0x20, //Horizontal Active Pixels, lower 8 bits
0x80, //Horizontal Blanking Pixels - lower 8 bits
0x30, //Upper nibble: upper 4 bits of Horizontal Active, Lower nibble, upper 4 bits of Horizontal Blankin
0xE0, //Vertical Active Lines, lower 8 bits
0x2D, //Vertical Blanking Lines, lower 8 bits
0x10, //Upper nibble: upper 4 bits of Vertical Active, Lower nibble, upper 4 bits of Vertical Blanking
0x28, //Horizontal Sync Offset (pixels from blanking starts, lower 8 bits)
0x30, //Horizontal Sync Pulse Width (pixels, lower 8 bits)
0xD3, //Upper nibble: lines, lower 4 bits of Vertical Sync Offset, Lower nibble: lines, lower 4 bits of Vertical Sync Pulse Width
0x00, //Two bit pairs containg the upper 2 bits of:
